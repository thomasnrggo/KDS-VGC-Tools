...
export function TeamCombinationCard({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-lg border border-mauve-200 p-3">
      <div className="flex items-start justify-between gap-2">
        ...
        <button
          ...
          className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-mauve-500 hover:bg-red-50 hover:text-red-600"
        >
      ...
      <textarea
        ...
        className="min-h-16 max-h-32 w-full resize-none overflow-y-auto rounded-lg border border-mauve-200 bg-mauve-100 p-2 text-sm text-mauve-800 focus:outline-none focus:ring-2 focus:ring-mauve-400"
      />
    </div>
  );
}
